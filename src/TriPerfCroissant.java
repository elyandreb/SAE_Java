 ...
 * en fonction de leur performance de manière croissante
 */
public class TriPerfCroissant implements Comparator<Athlete> {
     ...
     * @return Un entier négatif si la performance de a1 est inférieure à celle de a2
     *         un entier positif si la performance de a1 est supérieure à celle de a2
    ...
    public int compare(Athlete a1, Athlete a2) {
        ...
        return (int) (endurance1 - endurance2); // Ordre croissant
    }
