 ...
 * en fonction de leur agilité de manière croissante
 */
public class TriAgiliteCroissant implements Comparator<Athlete> {
     ...
     * @return Un entier négatif si l'agilité de a1 est inférieure à celle de a2
     *         un entier positif si l'agilité de a1 est supérieure à celle de a2
    ...
    public int compare(Athlete a1, Athlete a2) {
        ...
        return agilite1 - agilite2; // Ordre croissant
    }
