...
public class TriSexeHomme implements Comparator<Athlete> {
     ...
     * @return Un entier négatif si le sexe de a1 est "H" et celui de a2 est "F"
     *         un entier positif si le sexe de a1 est "F" et celui de a2 est "H"
     *         et zéro si les deux athlètes ont le même sexe
     */
    @Override
    public int compare(Athlete a1, Athlete a2) {
        if (a1.obtenirSexe().equals("H") && a2.obtenirSexe().equals("F")) {
            return -1;
        } else if (a1.obtenirSexe().equals("F") && a2.obtenirSexe().equals("H")) {
            return 1;
        } else {
