 ...
 * en fonction de leur force de manière croissante
 */
public class TriForceCroissant implements Comparator<Athlete> {
     ...
     * @return Un entier négatif si la force de a1 est inférieure à celle de a2
     *         un entier positif si la force de a1 est supérieure à celle de a2
    ...
    public int compare(Athlete a1, Athlete a2) {
        ...
        return force1 - force2; // Ordre croissant
    }
