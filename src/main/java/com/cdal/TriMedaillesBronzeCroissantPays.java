 ...
 * en fonction du nombre total de médailles de bronze dans l'ordre croissant
 */
public class TriMedaillesBronzeCroissantPays implements Comparator<Pays> {
     ...
     * @return Un entier négatif si p1 a moins de médailles de bronze que p2
     *         un entier positif si p1 a plus de médailles bronze que p2 
