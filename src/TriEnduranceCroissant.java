 ...
 * en fonction de leur endurance de manière croissante
 */
public class TriEnduranceCroissant implements Comparator<Athlete> {
     ...
     * @return Un entier négatif si l'endurance de a1 est inférieure à celle de a2
     *         un entier positif si l'endurance de a1 est supérieure à celle de a2
    ...
    public int compare(Athlete a1, Athlete a2) {
        ...
        return endurance1 - endurance2; // Ordre croissant
    }
